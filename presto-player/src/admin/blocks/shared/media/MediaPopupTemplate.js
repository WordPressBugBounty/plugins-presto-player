...
export default ( {
	...
	return (
		...
		>
			<div className="presto-media-popup-template__grid" data-cy="media-modal">
				...
				<div className="presto-media-popup-template__main">{ mainContent }</div>
				<div className="presto-media-popup-template__sidebar">{ sidebar }</div>
				<div className="presto-media-popup-template__footer">{ footer }</div>
			</div>
		</Modal>
	);
};
