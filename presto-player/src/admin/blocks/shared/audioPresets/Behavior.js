...
const { ToggleControl, BaseControl, SelectControl } = wp.components;

/* eslint-disable camelcase -- save_player_position, show_time_elapsed, play_video_viewport, sticky_scroll and on_video_end are preset data-contract keys (REST payload / DB columns); renaming them breaks the saved preset shape. */
