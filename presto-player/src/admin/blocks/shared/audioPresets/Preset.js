...
export default function ( {
	...
	const trashPreset = async () => {
		...
		try {
			...
			// eslint-disable-next-line no-console -- deliberate error reporting for a failed preset trash request.
			console.error( e );
			if ( e?.message ) {
				wp.data.dispatch( 'core/notices' ).createNotice(
	...
	return (
		// eslint-disable-next-line jsx-a11y/click-events-have-key-events -- adding keyboard handling changes interaction behaviour; out of scope for this translation-only PR.
		<div
		...
		>
			...
			{ ! preset?.is_locked && (
				<div className="block-editor-block-styles__item-edit">
					{ /* eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions -- converting to a button changes markup and keyboard behaviour; out of scope for this translation-only PR. */ }
					<div
