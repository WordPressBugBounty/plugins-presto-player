		...
		<div>
			{ fetchingLists ? (
				...
				<SelectControl
					...
					options={ lists }
					// eslint-disable-next-line camelcase -- `provider_list` is a stored preset/REST field name; renaming breaks the data contract.
					onChange={ ( provider_list ) =>
			...
			{ fetchingTags ? (
				...
				<SelectControl
					...
					options={ tags }
					// eslint-disable-next-line camelcase -- `provider_tag` is a stored preset/REST field name; renaming breaks the data contract.
