/* eslint-disable camelcase -- `action_bar`, `percentage_start`, `button_type`, `button_count`, `button_text` and `button_radius` are block attribute / preset REST payload keys; renaming would break the saved data contract. */
/**
...
export default function ActionBar( {
	...
	return (
		<div className={ className }>
			...
			{ !! action_bar?.enabled && (
				<>
					<BaseControl className="presto-player__control--percentage-watched presto-action-bar__range">
						<RangeControl
							...
							className="presto-action-bar__slider-fix"
						/>
					</BaseControl>
						...
						<Flex>
							...
							<ColorPopup
								...
								setColor={ ( backgroundColor ) =>
									updateActionBar( {
										background_color: backgroundColor && backgroundColor.hex,
									} )
								}
							/>
						</Flex>
						...
						<div>
							<BaseControl className="presto-player__control--button-text">
								<TextControl
									...
									help={
										<p>{ __( 'Submit button text', 'presto-player' ) }</p>
									}
									value={ action_bar?.button_text }
									onChange={ ( button_text ) =>
										updateActionBar( { button_text } )
									}
								/>
							</BaseControl>
							<BaseControl className="presto-player__control--button-text">
								...
								<Flex>
									...
									<ColorPopup
										...
										setColor={ ( buttonColor ) =>
											updateActionBar( {
												button_color: buttonColor && buttonColor.hex,
											} )
										}
									/>
								</Flex>
