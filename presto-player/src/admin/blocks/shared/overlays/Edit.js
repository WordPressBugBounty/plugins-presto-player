...
const EditOverlay = ( {
	...
	const updateOverlay = ( overlay, data = {} ) => {
		const itemIndex = overlays.indexOf( overlay );
		const updated = overlays.map( ( item, index ) => {
	...
	return (
		...
		>
			<div className="presto-player__preset-options" data-cy="preset-modal">
				...
				<div className="presto-overlays-edit__footer">
					<div className="presto-overlays-edit__meta"></div>
					<div>
						<Button
							isTertiary
							onClick={ closeModal }
