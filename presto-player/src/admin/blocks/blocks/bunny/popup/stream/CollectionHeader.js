	...
	return (
		<div className="presto-stream-collection-header">
			...
			{ modal && (
				...
				>
					<h2>
						{ /* eslint-disable-next-line @wordpress/i18n-no-flanking-whitespace -- the trailing space is part of the shipped msgid and is already translated in es/de/fr; removing it orphans those translations. Cleanup belongs with a catalog update. */ }
						{ __(
