...
import { ArrowLeft, Calendar, X, Info, PencilLine, Check } from 'lucide-react';
import {
	ResponsiveContainer,
	AreaChart,
	Area,
 ...
 * @param {Array}  root0.data Retention points, each `{ seconds, value }`.
 */
 ...
 *
 * @param {Object} root0       Component props.
 * @param {Object} root0.media Media item; requires `src`, and uses `title`/`poster`.
 */
...
const AnalyticsDetail = () => {
	...
	const { media, stats, isLoading, error, refetch } = useMediaDetail( mediaId );
						...
						<StatCard
							label={
								<span className="inline-flex items-center gap-1.5">
									...
									<ForceTooltip
										content={ __(
											'Each viewer is counted once, even if they watch the video multiple times.',
											'presto-player'
										) }
										arrow
										placement="right"
						...
						<StatCard
							label={
								<span className="inline-flex items-center gap-1.5">
									...
									<ForceTooltip
										content={ __(
											'Mean duration watched per view across all viewers in the selected date range.',
											'presto-player'
										) }
										arrow
										placement="right"
						...
						<StatCard
							...
							label={
								<span className="inline-flex items-center gap-1.5">
									...
									<ForceTooltip
										content={ __(
											'Shows how many viewers watched each moment of the video. Drop-offs indicate where people stopped watching.',
											'presto-player'
										) }
										arrow
										placement="right"
