 ...
 *
 * @param {Object} item Raw media item from the analytics API.
 * @return {Object} Flattened media item.
 */
 ...
 *
 * @param {Object} item Raw user item from the analytics API.
 * @return {Object} Flattened user item.
 */
