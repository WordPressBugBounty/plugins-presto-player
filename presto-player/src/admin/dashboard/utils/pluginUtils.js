/* eslint-disable no-console -- These console.error calls are deliberate error reporting for plugin install/activation failures, not debug leftovers. */
 ...
 * @return {Promise<boolean>} True if activation was successful
 *
 * @example
 ...
 * @return {Promise<void>} Resolves when all plugins are installed and activated
 *
 * @example
 ...
 * @return {Array<Object>} Array of plugin suggestions (max 4)
 *
 * @example
 * generateSuggestions(
 ...
 * @return {Promise<{success: boolean, data?: Object, error?: string}>} Resolves with the plugin status data on success, or an error message on failure.
 */
 ...
 * @return {Promise<{success: boolean, data?: Object, error?: string}>} Resolves with the install response data on success, or an error message on failure.
 */
 ...
 * @return {Promise<{success: boolean, data?: Object, error?: string}>} Resolves with the activation response data on success, or an error message on failure.
 */
