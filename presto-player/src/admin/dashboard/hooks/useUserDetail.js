 ...
 *
 * @param {number|string} userId - WordPress user ID whose analytics should be fetched.
 */
			...
			try {
				...
				try {
					...
					if ( analyticsErr.name !== 'AbortError' ) {
						// eslint-disable-next-line no-console -- deliberate warning when analytics endpoints are unavailable.
						console.warn(
				...
				if ( err.name !== 'AbortError' ) {
					...
					// eslint-disable-next-line no-console -- deliberate error reporting for a failed user detail fetch.
