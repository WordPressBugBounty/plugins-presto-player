...
const HIGHLIGHTS = [
	__(
		'Embed YouTube, Vimeo, Bunny.net, self-hosted videos, and audio',
		'presto-player'
	),
	...
	__(
		'Works with Gutenberg, Elementor, Divi, and major LMS plugins',
		'presto-player'
	),
];
...
const Welcome = ( { goToNextStep } ) => {
	...
	return (
		<>
			<Container direction="column" gap="lg" className="gap-6">
				<Container direction="column" gap="xs">
					...
					<Text size={ 16 } weight={ 500 }>
						{ __(
							'The Professional Video Player for WordPress.',
							'presto-player'
						) }
					</Text>
				</Container>
			...
			{ isVideoOpen && (
				/* eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions -- click-to-dismiss backdrop; adding keyboard handling/role changes markup and behaviour, out of scope for this translation-only PR. */
				<div
				...
				>
					...
					{ /* eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions -- wrapper only stops backdrop click propagation; adding keyboard handling/role changes markup and behaviour, out of scope for this translation-only PR. */ }
					<div
