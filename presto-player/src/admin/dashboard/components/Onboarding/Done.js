...
const TIPS = [
	__(
		'Use presets to keep a consistent player style across your site',
		'presto-player'
	),
	__(
		'Add captions and chapters to improve accessibility and engagement',
		'presto-player'
	),
	__(
		'Enable lazy loading in Settings → Performance for faster page loads',
		'presto-player'
	),
	__(
		'Check the Analytics tab to track how your audience engages with videos',
		'presto-player'
	),
];
		...
		<Container direction="column" gap="lg" className="gap-6">
			...
			<Container direction="column" gap="xs">
				<Text size={ 14 } weight={ 600 } color="primary">
					{ __(
						'Quick Tips to Get the Most Out of Presto Player:',
						'presto-player'
					) }
				</Text>
				{ TIPS.map( ( tip, index ) => (
