...
import { Label, Select, Text } from '@bsf/force-ui';
 ...
 * @param {Object} root0.data Analytics data containing `topMedia` and `topUsers`.
 */
							...
							>
								<div className="flex-1 min-w-0">
									{ hasLink ? (
										...
										>
											{ /* eslint-disable-next-line jsx-a11y/anchor-is-valid -- the wrapping Link component supplies the href/navigation; changing the markup is out of scope for this PR. */ }
