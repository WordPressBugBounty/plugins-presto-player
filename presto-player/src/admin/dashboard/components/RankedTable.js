 ...
 *
 * @param {number} currentPage The page currently being displayed (1-based).
 * @param {number} totalPages  Total number of pages available.
 * @param {number} siblings    How many pages to show on each side of the current page.
 * @param {number} boundary    How many pages to pin at the start and the end.
 * @return {Array<number|string>} Page numbers, with 'ellipsis-left'/'ellipsis-right' markers for gaps.
 */
const buildPagerWindow = (
	currentPage,
	totalPages,
	siblings = 1,
	boundary = 1
 ...
 * @param {JSX.Element} [props.emptyState] Rendered when `rows` is empty.
