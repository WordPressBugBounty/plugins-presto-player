 ...
 * @param {string}      root0.title       Heading text for the empty state.
 * @param {string|null} root0.description Secondary line; pass `null` to hide it.
 * @param {string}      root0.className   Extra classes for the container (height/padding).
 * @param {boolean}     root0.proGated    Whether this chart only fills in for Pro users.
 */
