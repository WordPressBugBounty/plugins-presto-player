...
import PrestoAdminIcons from '../utils/icons';
import {
	activatePlugin,
	installPlugins,
	generateSuggestions,
	...
	const primaryPluginsData = [
		{
			...
			svg: PrestoAdminIcons.sureforms,
		...
		},
		{
			id: '4',
			badgeText: __( 'Free', 'presto-player' ),
			svg: PrestoAdminIcons.suremembers,
	...
	const secondaryPluginsData = [
		{
			id: '5',
			badgeText: __( 'Free', 'presto-player' ),
			svg: PrestoAdminIcons.suremails,
			title: 'SureMails',
			description:
